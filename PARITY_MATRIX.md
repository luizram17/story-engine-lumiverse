...
| Player HUD / tracker widget | `frontend.ts` | Health, condition, level/XP, stats, money, inventory, gear, abilities, spells, wounds/status, tasks/commitments, world position and NPCs physically present. |
