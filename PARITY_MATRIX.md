...
|---|---|---|
| Player creation + existing-persona conversion | `core/character.ts`, Character UI, Personas API | 24-point PHY/MND/CHA buy, genre/race/details, generated sheet; can update active persona, create a new persona, or remain state-only. |
...
| Relationships / dispositions | `core/relationships.ts` | Bond/Fear/Hostility, contextual first impressions, anti-farming, romance/intimacy and explicit boundary state. |
