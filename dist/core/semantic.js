...
function normalizeActor(value) { const o = object(value); return { name: text(o.name).slice(0, 120), role: text(o.role).slice(0, 120) || 'NPC', rank: ranks.includes(String(o.rank)) ? o.rank : 'Average', capabilityPool: capabilityPools.includes(String(o.capabilityPool)) ? o.capabilityPool : undefined, mainStat: ['PHY', 'MND', 'CHA', 'Balanced'].includes(String(o.mainStat)) ? o.mainStat : undefined, relation: ['direct', 'opposed', 'benefited', 'harmed', 'observer', 'neutral'].includes(String(o.relation)) ? o.relation : 'neutral', powerActor: bool(o.powerActor, false), companion: bool(o.companion, false), initialBond: o.initialBond == null ? undefined : clampInt(o.initialBond, 0, 4, 0), initialFear: o.initialFear == null ? undefined : clampInt(o.initialFear, 0, 4, 0), initialHostility: o.initialHostility == null ? undefined : clampInt(o.initialHostility, 0, 4, 0), initialRomanceStage: ['none', 'interest', 'dating', 'partner'].includes(String(o.initialRomanceStage)) ? o.initialRomanceStage : undefined, initialIntimacy: o.initialIntimacy == null ? undefined : clampInt(o.initialIntimacy, 0, 4, 0), personalityArchetype: text(o.personalityArchetype).slice(0, 80) || undefined, personalitySummary: text(o.personalitySummary).slice(0, 500) || undefined, initialNotes: Array.isArray(o.initialNotes) ? o.initialNotes.map((x) => text(x)).filter(Boolean).slice(0, 8) : undefined, relationshipContext: text(o.relationshipContext).slice(0, 300) || undefined, initialRelationshipDescriptors: Array.isArray(o.initialRelationshipDescriptors) ? o.initialRelationshipDescriptors.map((x) => text(x).slice(0, 100)).filter(Boolean).slice(0, 12) : undefined, evidence: text(o.evidence).slice(0, 240) || undefined }; }
